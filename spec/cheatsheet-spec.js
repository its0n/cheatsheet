...
describe('Cheatsheet', () => {
  ...
  describe('when the cheatsheet:toggle event is triggered', () => {
    it('hides and shows the modal panel', () => {
      ...
      runs(() => {
        ...
        let cheatsheetElement = workspaceElement.querySelector('.cheatsheet');
        expect(cheatsheetElement).toExist();

        let cheatsheetPanel = atom.workspace.panelForItem(cheatsheetElement);
